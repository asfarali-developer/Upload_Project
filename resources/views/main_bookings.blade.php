   ...
   <!-- offers_area_start -->
    <div class="offers_area">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <h1 style='text-align:center; margin-bottom:20px;'> Our Bookings </h1>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>{{$b->guest_name}}</td>
      <td>
          <a href="{{ url('/booking/edit', $b->id) }}" class ='btn btn-info btn-sm'>Edit</a>
          <a href="{{ url('/booking/delete', $b->id) }}" class ='btn btn-danger btn-sm'>Delete</a>
      </td>
    </tr>
    @endforeach
  </tbody>
    ...
    <input type="number" class="form-control" name='room_num'
    id="exampleInputEmail1" aria-describedby="emailHelp"  >
  </div>
